...
app.config['MAIL_USERNAME'] = 'curosai80@gmail.com'
app.config['MAIL_PASSWORD'] = 'oomxsqauimpvbrkj'
...
def send_mail():
    print(mail)
    msg = Message("Hello", sender="curosai80@gmail.com", recipients=["monroyorlando.36@gmail.com"])
    msg.body = "Porque eres feita" 
    mail.send(msg)
    return "Mail sent"
